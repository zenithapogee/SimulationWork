...
def generate_launch_description():
    ...
    world_file_path = os.path.join(get_package_share_directory(pkg_name), 'worlds/ocean2.world')
    ...
    # # Spawn the robot_2 (vessel) entity in Gazebo using URDF
    ...
    listener_node_1 = Node(
        ...
        namespace="robot_1",
        output="screen",
        arguments=['/my_camera/image_raw','0','0']
       
    )
    
    #  Start image pipeline node for camera 2. Arguments: topic, center_offset_x,center_offset_y
    listener_node_2 = Node(
        package="my_package",
        executable="image_listener.py",
        namespace="robot_2",
        output="screen",
        arguments=['/my_camera2/image_raw','0','0']
    )
